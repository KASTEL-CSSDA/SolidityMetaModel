...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.soliditymetamodel.soliditysystem.Instance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Instance_contract_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Instance_contract_feature", "_UI_Instance_type"),
				 SoliditySystemPackage.Literals.INSTANCE__CONTRACT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoliditySystemPackage.Literals.INSTANCE__PROVIDED_INTERFACES);
			childrenFeatures.add(SoliditySystemPackage.Literals.INSTANCE__REQUIRED_INTERFACES);
		}
	...
	public String getText(Object object) {
		...
		String name =  instance.getContract() == null ? "" : instance.getContract().getEntityName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SoliditySystemPackage.Literals.INSTANCE__PROVIDED_INTERFACES,
				 SoliditySystemFactory.eINSTANCE.createProvidedInterface()));

		newChildDescriptors.add
			(createChildParameter
				(SoliditySystemPackage.Literals.INSTANCE__REQUIRED_INTERFACES,
				 SoliditySystemFactory.eINSTANCE.createRequiredInterface()));
	}
