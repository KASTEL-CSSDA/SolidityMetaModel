...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_anonymous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_anonymous_feature", "_UI_Event_type"),
				 SolidityContractsPackage.Literals.EVENT__ANONYMOUS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SolidityContractsPackage.Literals.EVENT__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = ((Event)object).getEntityName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Event.class)) {
			case SolidityContractsPackage.EVENT__ANONYMOUS:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SolidityContractsPackage.EVENT__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SolidityContractsPackage.Literals.EVENT__PARAMETERS,
				 SolidityContractsFactory.eINSTANCE.createEventParameter()));
	}
