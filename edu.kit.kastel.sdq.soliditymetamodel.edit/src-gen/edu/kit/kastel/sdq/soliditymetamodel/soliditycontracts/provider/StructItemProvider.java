...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.Struct} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructItemProvider extends IdentifierItemProvider {
	/**
	...
	protected void addDataLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Struct_dataLocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Struct_dataLocation_feature", "_UI_Struct_type"),
				 SolidityContractsPackage.Literals.STRUCT__DATA_LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SolidityContractsPackage.Literals.STRUCT__MEMBERS);
		}
	...
	public String getText(Object object) {
		String label = ((Struct)object).getEntityName() + ((Struct)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SolidityContractsPackage.Literals.STRUCT__MEMBERS,
				 SolidityContractsFactory.eINSTANCE.createStructMember()));
	}
