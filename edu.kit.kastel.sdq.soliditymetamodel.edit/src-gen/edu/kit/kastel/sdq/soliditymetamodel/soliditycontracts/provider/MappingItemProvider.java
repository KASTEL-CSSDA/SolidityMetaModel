...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.Mapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mapping_keyType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mapping_keyType_feature", "_UI_Mapping_type"),
				 SolidityContractsPackage.Literals.MAPPING__KEY_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValueTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mapping_valueType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mapping_valueType_feature", "_UI_Mapping_type"),
				 SolidityContractsPackage.Literals.MAPPING__VALUE_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDataLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Mapping_dataLocation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Mapping_dataLocation_feature", "_UI_Mapping_type"),
				 SolidityContractsPackage.Literals.MAPPING__DATA_LOCATION,
				 true,
				 false,
				 false,
