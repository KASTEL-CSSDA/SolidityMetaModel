...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.FunctionParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionParameterItemProvider extends IdentifierItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionParameter_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionParameter_name_feature", "_UI_FunctionParameter_type"),
				 SolidityContractsPackage.Literals.FUNCTION_PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionParameter_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionParameter_type_feature", "_UI_FunctionParameter_type"),
				 SolidityContractsPackage.Literals.FUNCTION_PARAMETER__TYPE,
				 true,
				 false,
				 true,
				 null,
