 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.impl.EventImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.impl.EventImpl#isAnonymous <em>Anonymous</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends NamedElementImpl implements Event {
	...
	protected EClass eStaticClass() {
		return SolidityContractsPackage.Literals.EVENT;
	}
	...
	public EList<EventParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<EventParameter>(EventParameter.class, this, SolidityContractsPackage.EVENT__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setAnonymous(boolean newAnonymous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SolidityContractsPackage.EVENT__ANONYMOUS, oldAnonymous, anonymous));
	}
