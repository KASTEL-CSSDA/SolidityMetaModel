 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.soliditymetamodel.soliditycontracts.impl.PrimitiveTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends IdentifierImpl implements PrimitiveType {
	/**
	 ...
	 * @ordered
	 */
	protected static final PrimitiveTypeEnum TYPE_EDEFAULT = PrimitiveTypeEnum.BOOL;
	...
	protected EClass eStaticClass() {
		return SolidityContractsPackage.Literals.PRIMITIVE_TYPE;
	}
	...
	public void setType(PrimitiveTypeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SolidityContractsPackage.PRIMITIVE_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SolidityContractsPackage.PRIMITIVE_TYPE__TYPE:
				return getType();
		}
