 ...
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='ContractNameMustBeUnique GlobalFunctionCanOnlyUseGlobalTypes LocalFunctionsCanOnlyUseLocalTypesOfContractOrGlobalTypes VariablesCanOnlyUseLocalTypesOfContractOrGlobalTypes EventsCanOnlyUseLocalTypesOfContractOrGlobalTypes ModifiersCanOnlyUseLocalTypesOfContractOrGlobalTypes'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot ContractNameMustBeUnique='contracts -&gt; isUnique(entityName)' GlobalFunctionCanOnlyUseGlobalTypes='globalTypes -&gt; includesAll(globalFunctions -&gt; collect(returnVariables) -&gt; collect(type) -&gt; union(globalFunctions -&gt; collect(parameters) -&gt; collect(type)))' LocalFunctionsCanOnlyUseLocalTypesOfContractOrGlobalTypes='contracts -&gt; forAll(c|c.localTypes -&gt; union(globalTypes) -&gt; includesAll(c.localFunctions -&gt; collect(parameters) -&gt; collect(type) -&gt; union(c.localFunctions -&gt; collect(returnVariables) -&gt; collect(type))))' VariablesCanOnlyUseLocalTypesOfContractOrGlobalTypes='contracts -&gt; forAll(c|c.localTypes -&gt; union(globalTypes) -&gt; includesAll(c.variables -&gt; collect(type)))' EventsCanOnlyUseLocalTypesOfContractOrGlobalTypes='contracts -&gt; forAll(c|c.localTypes -&gt; union(globalTypes) -&gt; includesAll(c.events -&gt; collect(parameters) -&gt; collect(type)))' ModifiersCanOnlyUseLocalTypesOfContractOrGlobalTypes='contracts -&gt; forAll(c|c.localTypes -&gt; union(globalTypes) -&gt; includesAll(c.modifiers -&gt; collect(parameters) -&gt; collect(type)))'"
 * @generated
 */
