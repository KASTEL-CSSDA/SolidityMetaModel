 ...
 * @generated
 */
public class SoliditySystemAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static SoliditySystemPackage modelPackage;
	 ...
	 * @generated
	 */
	public SoliditySystemAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = SoliditySystemPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected SoliditySystemSwitch<Adapter> modelSwitch =
		new SoliditySystemSwitch<Adapter>() {
			@Override
			public Adapter caseSystemAssembly(SystemAssembly object) {
				return createSystemAssemblyAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.soliditymetamodel.soliditysystem.SystemAssembly <em>System Assembly</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.soliditymetamodel.soliditysystem.Instance <em>Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.soliditymetamodel.soliditysystem.Connector <em>Connector</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.soliditymetamodel.soliditysystem.ProvidedInterface <em>Provided Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.soliditymetamodel.soliditysystem.RequiredInterface <em>Required Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
